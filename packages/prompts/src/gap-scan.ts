...
export async function runGapScan(args: {
  tenantName: string;
  kbSummary: Array<{ module: string; entries: Array<{ id: string; data: unknown; updated_at: string }> }>;
    ...
    system: [
      {
        type: "text",
        text:
          "You audit a tenant's knowledge base for: missing content, stale content (>30d unchanged), translation gaps (missing AR/EN), consistency issues (contradictions), and low-served entries (never served in 30d). Return JSON: {\"suggestions\":[{\"type\":\"...\",\"module_slug\":\"...\",\"description\":\"...\"}]} with no prose.",
